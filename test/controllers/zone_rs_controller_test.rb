...
class ZoneRsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone_r" do
    assert_difference("ZoneR.count") do
      post zone_rs_url, params: { zone_r: { desk_id: @zone_r.desk_id, furniture: @zone_r.furniture, lan_port: @zone_r.lan_port, personnel: @zone_r.personnel, power_socket: @zone_r.power_socket, status: @zone_r.status } }
    end
  ...
  test "should update zone_r" do
    patch zone_r_url(@zone_r), params: { zone_r: { desk_id: @zone_r.desk_id, furniture: @zone_r.furniture, lan_port: @zone_r.lan_port, personnel: @zone_r.personnel, power_socket: @zone_r.power_socket, status: @zone_r.status } }
