...
class ZoneNsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone_n" do
    assert_difference("ZoneN.count") do
      post zone_ns_url, params: { zone_n: { desk_id: @zone_n.desk_id, furniture: @zone_n.furniture, lan_port: @zone_n.lan_port, personnel: @zone_n.personnel, power_socket: @zone_n.power_socket, status: @zone_n.status } }
    end
  ...
  test "should update zone_n" do
    patch zone_n_url(@zone_n), params: { zone_n: { desk_id: @zone_n.desk_id, furniture: @zone_n.furniture, lan_port: @zone_n.lan_port, personnel: @zone_n.personnel, power_socket: @zone_n.power_socket, status: @zone_n.status } }
