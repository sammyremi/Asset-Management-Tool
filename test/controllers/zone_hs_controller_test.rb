...
class ZoneHsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone_h" do
    assert_difference("ZoneH.count") do
      post zone_hs_url, params: { zone_h: { desk_id: @zone_h.desk_id, furniture: @zone_h.furniture, lan_port: @zone_h.lan_port, personel: @zone_h.personel, power_socket: @zone_h.power_socket, status: @zone_h.status } }
    end
  ...
  test "should update zone_h" do
    patch zone_h_url(@zone_h), params: { zone_h: { desk_id: @zone_h.desk_id, furniture: @zone_h.furniture, lan_port: @zone_h.lan_port, personel: @zone_h.personel, power_socket: @zone_h.power_socket, status: @zone_h.status } }
