...
class ZoneIsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone_i" do
    assert_difference("ZoneI.count") do
      post zone_is_url, params: { zone_i: { desk_id: @zone_i.desk_id, furniture: @zone_i.furniture, lan_port: @zone_i.lan_port, personel: @zone_i.personel, power_socket: @zone_i.power_socket, status: @zone_i.status } }
    end
  ...
  test "should update zone_i" do
    patch zone_i_url(@zone_i), params: { zone_i: { desk_id: @zone_i.desk_id, furniture: @zone_i.furniture, lan_port: @zone_i.lan_port, personel: @zone_i.personel, power_socket: @zone_i.power_socket, status: @zone_i.status } }
