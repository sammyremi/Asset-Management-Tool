...
class ZoneKsTest < ApplicationSystemTestCase
  ...
  test "should create zone k" do
    ...
    fill_in "Desk id", with: @zone_k.Desk_ID
    fill_in "Furniture", with: @zone_k.Furniture
    fill_in "Lan port", with: @zone_k.LAN_Port
    fill_in "Personnel", with: @zone_k.Personnel
    fill_in "Power socket", with: @zone_k.Power_Socket
