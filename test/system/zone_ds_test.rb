...
class ZoneDsTest < ApplicationSystemTestCase
  ...
  test "should create zone d" do
    ...
    fill_in "Furniture", with: @zone_d.furniture
    fill_in "Lan port", with: @zone_d.lan_port
    fill_in "Personel", with: @zone_d.personel
    fill_in "Power socket", with: @zone_d.power_socket
