...
class ZoneIsTest < ApplicationSystemTestCase
  ...
  test "should create zone i" do
    ...
    fill_in "Furniture", with: @zone_i.furniture
    fill_in "Lan port", with: @zone_i.lan_port
    fill_in "Personel", with: @zone_i.personel
    fill_in "Power socket", with: @zone_i.power_socket
