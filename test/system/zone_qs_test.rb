...
class ZoneQsTest < ApplicationSystemTestCase
  ...
  test "should create zone q" do
    ...
    fill_in "Furniture", with: @zone_q.furniture
    fill_in "Lan port", with: @zone_q.lan_port
    fill_in "Personnel", with: @zone_q.personnel
    fill_in "Power socket", with: @zone_q.power_socket
