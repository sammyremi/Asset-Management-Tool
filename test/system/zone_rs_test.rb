...
class ZoneRsTest < ApplicationSystemTestCase
  ...
  test "should create zone r" do
    ...
    fill_in "Furniture", with: @zone_r.furniture
    fill_in "Lan port", with: @zone_r.lan_port
    fill_in "Personnel", with: @zone_r.personnel
    fill_in "Power socket", with: @zone_r.power_socket
