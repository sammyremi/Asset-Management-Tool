...
class ZoneLsTest < ApplicationSystemTestCase
  ...
  test "should create zone l" do
    ...
    fill_in "Desk id", with: @zone_l.Desk_ID
    fill_in "Furniture", with: @zone_l.Furniture
    fill_in "Lan port", with: @zone_l.LAN_Port
    fill_in "Personnel", with: @zone_l.Personnel
    fill_in "Power socket", with: @zone_l.Power_Socket
