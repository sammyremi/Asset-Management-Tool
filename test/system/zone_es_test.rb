...
class ZoneEsTest < ApplicationSystemTestCase
  ...
  test "should create zone e" do
    ...
    fill_in "Furniture", with: @zone_e.furniture
    fill_in "Lan port", with: @zone_e.lan_port
    fill_in "Personel", with: @zone_e.personel
    fill_in "Power socket", with: @zone_e.power_socket
