class AccessPointsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @access_point.save
        format.html { redirect_to access_point_url(@access_point), notice: "Access point was successfully created." }
  ...
  def update
    respond_to do |format|
      if @access_point.update(access_point_params)
        format.html { redirect_to access_point_url(@access_point), notice: "Access point was successfully updated." }
  ...
  private
    ...
    def access_point_params
      params.require(:access_point).permit(:IP_Phone, :manufacturer, :brand_model, :zone, :department, :condition, :asset_state, :serial_number, :location)
    end
end
